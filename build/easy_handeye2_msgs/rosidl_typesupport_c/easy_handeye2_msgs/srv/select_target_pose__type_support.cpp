...
static const _SelectTargetPose_Request_type_support_symbol_names_t _SelectTargetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, SelectTargetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, easy_handeye2_msgs, srv, SelectTargetPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, easy_handeye2_msgs, srv, SelectTargetPose_Request)() {
  return &::easy_handeye2_msgs::srv::rosidl_typesupport_c::SelectTargetPose_Request_message_type_support_handle;
}
...
static const _SelectTargetPose_Response_type_support_symbol_names_t _SelectTargetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, SelectTargetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, easy_handeye2_msgs, srv, SelectTargetPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, easy_handeye2_msgs, srv, SelectTargetPose_Response)() {
  return &::easy_handeye2_msgs::srv::rosidl_typesupport_c::SelectTargetPose_Response_message_type_support_handle;
}
...
static const _SelectTargetPose_type_support_symbol_names_t _SelectTargetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, SelectTargetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, easy_handeye2_msgs, srv, SelectTargetPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, easy_handeye2_msgs, srv, SelectTargetPose)() {
  return &::easy_handeye2_msgs::srv::rosidl_typesupport_c::SelectTargetPose_service_type_support_handle;
}
