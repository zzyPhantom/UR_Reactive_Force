...
static const _RemoveSample_Request_type_support_symbol_names_t _RemoveSample_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, RemoveSample_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, easy_handeye2_msgs, srv, RemoveSample_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, easy_handeye2_msgs, srv, RemoveSample_Request)() {
  return &::easy_handeye2_msgs::srv::rosidl_typesupport_c::RemoveSample_Request_message_type_support_handle;
}
...
static const _RemoveSample_Response_type_support_symbol_names_t _RemoveSample_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, RemoveSample_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, easy_handeye2_msgs, srv, RemoveSample_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, easy_handeye2_msgs, srv, RemoveSample_Response)() {
  return &::easy_handeye2_msgs::srv::rosidl_typesupport_c::RemoveSample_Response_message_type_support_handle;
}
...
static const _RemoveSample_type_support_symbol_names_t _RemoveSample_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, RemoveSample)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, easy_handeye2_msgs, srv, RemoveSample)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, easy_handeye2_msgs, srv, RemoveSample)() {
  return &::easy_handeye2_msgs::srv::rosidl_typesupport_c::RemoveSample_service_type_support_handle;
}
