...
bool easy_handeye2_msgs__msg__handeye_calibration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("easy_handeye2_msgs.msg._handeye_calibration.HandeyeCalibration", full_classname_dest, 62) == 0);
  }
  easy_handeye2_msgs__msg__HandeyeCalibration * ros_message = _ros_message;
  {  // parameters
...
{
  /* NOTE(esteve): Call constructor of HandeyeCalibration */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("easy_handeye2_msgs.msg._handeye_calibration");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HandeyeCalibration");
