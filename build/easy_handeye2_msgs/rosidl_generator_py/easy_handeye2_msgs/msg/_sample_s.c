...
bool easy_handeye2_msgs__msg__sample__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("easy_handeye2_msgs.msg._sample.Sample", full_classname_dest, 37) == 0);
  }
  easy_handeye2_msgs__msg__Sample * ros_message = _ros_message;
  {  // robot
    PyObject * field = PyObject_GetAttrString(_pymsg, "robot");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__transform__convert_from_py(field, &ros_message->robot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // tracking
    ...
    if (!geometry_msgs__msg__transform__convert_from_py(field, &ros_message->tracking)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * easy_handeye2_msgs__msg__sample__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("easy_handeye2_msgs.msg._sample");
  ...
  {  // robot
    PyObject * field = NULL;
    field = geometry_msgs__msg__transform__convert_to_py(&ros_message->robot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // tracking
    PyObject * field = NULL;
    field = geometry_msgs__msg__transform__convert_to_py(&ros_message->tracking);
    if (!field) {
      return NULL;
    }
    {
