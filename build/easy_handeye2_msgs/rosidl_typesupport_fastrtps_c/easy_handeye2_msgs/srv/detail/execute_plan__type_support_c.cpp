...
#include "easy_handeye2_msgs/srv/detail/execute_plan__rosidl_typesupport_fastrtps_c.h"
...
using _ExecutePlan_Request__ros_msg_type = easy_handeye2_msgs__srv__ExecutePlan_Request;
...
size_t get_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Request(
  const void * untyped_ros_message,
...
static uint32_t _ExecutePlan_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_easy_handeye2_msgs
size_t max_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = easy_handeye2_msgs__srv__ExecutePlan_Request;
    is_plain =
      (
...
static size_t _ExecutePlan_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, ExecutePlan_Request)() {
...
using _ExecutePlan_Response__ros_msg_type = easy_handeye2_msgs__srv__ExecutePlan_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_easy_handeye2_msgs
size_t get_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecutePlan_Response__ros_msg_type * ros_message = static_cast<const _ExecutePlan_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_easy_handeye2_msgs
size_t max_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = easy_handeye2_msgs__srv__ExecutePlan_Response;
    is_plain =
      (
...
static size_t _ExecutePlan_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_easy_handeye2_msgs__srv__ExecutePlan_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, ExecutePlan_Response)() {
...
// already included above
// #include "easy_handeye2_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "easy_handeye2_msgs/srv/execute_plan.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, easy_handeye2_msgs, srv, ExecutePlan)() {
