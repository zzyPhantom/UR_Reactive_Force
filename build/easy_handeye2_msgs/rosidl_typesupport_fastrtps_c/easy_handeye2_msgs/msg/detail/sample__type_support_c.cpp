...
#include "easy_handeye2_msgs/msg/detail/sample__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/transform__functions.h"  // robot, tracking
...
using _Sample__ros_msg_type = easy_handeye2_msgs__msg__Sample;
...
static uint32_t _Sample__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_easy_handeye2_msgs__msg__Sample(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = easy_handeye2_msgs__msg__Sample;
    is_plain =
      (
...
static size_t _Sample__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_easy_handeye2_msgs__msg__Sample(
