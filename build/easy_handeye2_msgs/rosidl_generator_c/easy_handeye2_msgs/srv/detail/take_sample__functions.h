...
#ifndef EASY_HANDEYE2_MSGS__SRV__DETAIL__TAKE_SAMPLE__FUNCTIONS_H_
#define EASY_HANDEYE2_MSGS__SRV__DETAIL__TAKE_SAMPLE__FUNCTIONS_H_
...
/// Initialize srv/TakeSample message.
/**
...
/// Finalize srv/TakeSample message.
/**
...
/// Create srv/TakeSample message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * easy_handeye2_msgs__srv__TakeSample_Request__init().
...
/// Destroy srv/TakeSample message.
/**
 * It calls
 * easy_handeye2_msgs__srv__TakeSample_Request__fini()
...
/// Check for srv/TakeSample message equality.
/**
...
/// Initialize array of srv/TakeSample messages.
/**
...
/// Finalize array of srv/TakeSample messages.
/**
 * It calls
 * easy_handeye2_msgs__srv__TakeSample_Request__fini()
...
/// Create array of srv/TakeSample messages.
/**
 * It allocates the memory for the array and calls
 * easy_handeye2_msgs__srv__TakeSample_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TakeSample messages.
/**
 * It calls
 * easy_handeye2_msgs__srv__TakeSample_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TakeSample message array equality.
/**
...
/// Copy an array of srv/TakeSample messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * easy_handeye2_msgs__srv__TakeSample_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_easy_handeye2_msgs
...
/**
 * It calls
 * easy_handeye2_msgs__srv__TakeSample_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_easy_handeye2_msgs
...
/**
 * It allocates the memory for the array and calls
 * easy_handeye2_msgs__srv__TakeSample_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_easy_handeye2_msgs
...
/**
 * It calls
 * easy_handeye2_msgs__srv__TakeSample_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EASY_HANDEYE2_MSGS__SRV__DETAIL__TAKE_SAMPLE__FUNCTIONS_H_
