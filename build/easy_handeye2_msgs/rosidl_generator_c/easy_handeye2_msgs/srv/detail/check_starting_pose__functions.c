...
easy_handeye2_msgs__srv__CheckStartingPose_Request__create()
{
  ...
  easy_handeye2_msgs__srv__CheckStartingPose_Request * msg = (easy_handeye2_msgs__srv__CheckStartingPose_Request *)allocator.allocate(sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Request));
  bool success = easy_handeye2_msgs__srv__CheckStartingPose_Request__init(msg);
  if (!success) {
...
easy_handeye2_msgs__srv__CheckStartingPose_Request__destroy(easy_handeye2_msgs__srv__CheckStartingPose_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    easy_handeye2_msgs__srv__CheckStartingPose_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence__init(easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  easy_handeye2_msgs__srv__CheckStartingPose_Request * data = NULL;

  if (size) {
    data = (easy_handeye2_msgs__srv__CheckStartingPose_Request *)allocator.zero_allocate(size, sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = easy_handeye2_msgs__srv__CheckStartingPose_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        easy_handeye2_msgs__srv__CheckStartingPose_Request__fini(&data[i - 1]);
      }
...
easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence__fini(easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      easy_handeye2_msgs__srv__CheckStartingPose_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * array = (easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence *)allocator.allocate(sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence__init(array, size);
  if (!success) {
...
easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence__destroy(easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence__are_equal(const easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * lhs, const easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!easy_handeye2_msgs__srv__CheckStartingPose_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  easy_handeye2_msgs__srv__CheckStartingPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    easy_handeye2_msgs__srv__CheckStartingPose_Request * data =
      (easy_handeye2_msgs__srv__CheckStartingPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!easy_handeye2_msgs__srv__CheckStartingPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          easy_handeye2_msgs__srv__CheckStartingPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!easy_handeye2_msgs__srv__CheckStartingPose_Request__copy(
...
easy_handeye2_msgs__srv__CheckStartingPose_Response__init(easy_handeye2_msgs__srv__CheckStartingPose_Response * msg)
{
  ...
  if (!easy_handeye2_msgs__msg__TargetPoseList__init(&msg->target_poses)) {
    easy_handeye2_msgs__srv__CheckStartingPose_Response__fini(msg);
    return false;
  }
  return true;
}
...
easy_handeye2_msgs__srv__CheckStartingPose_Response__are_equal(const easy_handeye2_msgs__srv__CheckStartingPose_Response * lhs, const easy_handeye2_msgs__srv__CheckStartingPose_Response * rhs)
{
  ...
  // can_calibrate
  if (lhs->can_calibrate != rhs->can_calibrate) {
    return false;
  }
  // target_poses
  ...
  easy_handeye2_msgs__srv__CheckStartingPose_Response * output)
{
  ...
  // can_calibrate
  output->can_calibrate = input->can_calibrate;
  // target_poses
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  easy_handeye2_msgs__srv__CheckStartingPose_Response * msg = (easy_handeye2_msgs__srv__CheckStartingPose_Response *)allocator.allocate(sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Response));
  bool success = easy_handeye2_msgs__srv__CheckStartingPose_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence__init(easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  easy_handeye2_msgs__srv__CheckStartingPose_Response * data = NULL;

  if (size) {
    data = (easy_handeye2_msgs__srv__CheckStartingPose_Response *)allocator.zero_allocate(size, sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = easy_handeye2_msgs__srv__CheckStartingPose_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        easy_handeye2_msgs__srv__CheckStartingPose_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence__fini(easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      easy_handeye2_msgs__srv__CheckStartingPose_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * array = (easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence *)allocator.allocate(sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence__destroy(easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence__are_equal(const easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * lhs, const easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!easy_handeye2_msgs__srv__CheckStartingPose_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  easy_handeye2_msgs__srv__CheckStartingPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(easy_handeye2_msgs__srv__CheckStartingPose_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    easy_handeye2_msgs__srv__CheckStartingPose_Response * data =
      (easy_handeye2_msgs__srv__CheckStartingPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!easy_handeye2_msgs__srv__CheckStartingPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          easy_handeye2_msgs__srv__CheckStartingPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!easy_handeye2_msgs__srv__CheckStartingPose_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
