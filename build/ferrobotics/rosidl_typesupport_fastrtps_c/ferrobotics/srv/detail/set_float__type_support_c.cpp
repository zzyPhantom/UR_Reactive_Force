...
#include "ferrobotics/srv/detail/set_float__rosidl_typesupport_fastrtps_c.h"
...
using _SetFloat_Request__ros_msg_type = ferrobotics__srv__SetFloat_Request;
...
size_t get_serialized_size_ferrobotics__srv__SetFloat_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetFloat_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ferrobotics__srv__SetFloat_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ferrobotics
size_t max_serialized_size_ferrobotics__srv__SetFloat_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ferrobotics__srv__SetFloat_Request;
    is_plain =
      (
...
static size_t _SetFloat_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ferrobotics__srv__SetFloat_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ferrobotics, srv, SetFloat_Request)() {
...
using _SetFloat_Response__ros_msg_type = ferrobotics__srv__SetFloat_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ferrobotics
size_t get_serialized_size_ferrobotics__srv__SetFloat_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetFloat_Response__ros_msg_type * ros_message = static_cast<const _SetFloat_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ferrobotics__srv__SetFloat_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ferrobotics
size_t max_serialized_size_ferrobotics__srv__SetFloat_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ferrobotics__srv__SetFloat_Response;
    is_plain =
      (
...
static size_t _SetFloat_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ferrobotics__srv__SetFloat_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ferrobotics, srv, SetFloat_Response)() {
...
// already included above
// #include "ferrobotics/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ferrobotics/srv/set_float.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ferrobotics, srv, SetFloat)() {
