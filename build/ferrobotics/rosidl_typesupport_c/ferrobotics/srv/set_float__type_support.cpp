...
static const _SetFloat_Request_type_support_symbol_names_t _SetFloat_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ferrobotics, srv, SetFloat_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ferrobotics, srv, SetFloat_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ferrobotics, srv, SetFloat_Request)() {
  return &::ferrobotics::srv::rosidl_typesupport_c::SetFloat_Request_message_type_support_handle;
}
...
static const _SetFloat_Response_type_support_symbol_names_t _SetFloat_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ferrobotics, srv, SetFloat_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ferrobotics, srv, SetFloat_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ferrobotics, srv, SetFloat_Response)() {
  return &::ferrobotics::srv::rosidl_typesupport_c::SetFloat_Response_message_type_support_handle;
}
...
static const _SetFloat_type_support_symbol_names_t _SetFloat_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ferrobotics, srv, SetFloat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ferrobotics, srv, SetFloat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ferrobotics, srv, SetFloat)() {
  return &::ferrobotics::srv::rosidl_typesupport_c::SetFloat_service_type_support_handle;
}
