...
#ifndef FERROBOTICS__SRV__DETAIL__SET_FLOAT__FUNCTIONS_H_
#define FERROBOTICS__SRV__DETAIL__SET_FLOAT__FUNCTIONS_H_
 ...
 * calls
 * ferrobotics__srv__SetFloat_Request__init().
...
/**
 * It calls
 * ferrobotics__srv__SetFloat_Request__fini()
 ...
 * ferrobotics__srv__SetFloat_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ferrobotics__srv__SetFloat_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ferrobotics__srv__SetFloat_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ferrobotics
...
/**
 * It calls
 * ferrobotics__srv__SetFloat_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ferrobotics
...
/**
 * It allocates the memory for the array and calls
 * ferrobotics__srv__SetFloat_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ferrobotics
...
/**
 * It calls
 * ferrobotics__srv__SetFloat_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FERROBOTICS__SRV__DETAIL__SET_FLOAT__FUNCTIONS_H_
