...
#include "ferrobotics/srv/detail/set_float__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ferrobotics::srv::SetFloat_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ferrobotics::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ferrobotics::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  return &ferrobotics::srv::typesupport_fastrtps_cpp::_SetFloat_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ferrobotics::srv::SetFloat_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ferrobotics::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ferrobotics::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ferrobotics::srv::typesupport_fastrtps_cpp::_SetFloat_Response__handle;
}
...
{
  return &ferrobotics::srv::typesupport_fastrtps_cpp::_SetFloat__handle;
}
